...
public class ProductDAO extends GenericDAOImpl<Product, Integer> {
    ...
    public List<Product> findByProductName(String productName) {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("SELECT p FROM Product p WHERE p.name LIKE :productName", Product.class)
    ...
    public List<Product> findExactProductByName(String productName) {
        EntityManager em = emf.createEntityManager();
        try {
