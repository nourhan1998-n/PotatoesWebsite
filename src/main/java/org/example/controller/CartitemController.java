    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("set".equals(action)) {
            ...
            if (user != null) {
                ...
                Product product = productService.getProductById(productId);// In real case, you'd retrieve it using a ProductService

                Cartitem cartitem = cartitemService.findByUserIdAndProductId(user.getId(),productId);
                //if product id is found increase quantity
                if (cartitem!=null)
                {
