...
<form id="editProductForm" method="POST" action="/VegesFoodWebsite/EditProductServlet">
    ...
    <input type="text" name="name" value="Onion" required><br>
    <label for="price">Price:</label>
    <input type="number" name="price" value="10" required><br>
    <label for="quantity">Quantity:</label>
    <input type="number" name="quantity" value="10" required><br>
